...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const bannerEmbed = new EmbedBuilder().setImage(config.bannerUrl).setColor(0x5865f2);
    const msg = await panelChannel.send({ embeds: [bannerEmbed], components: [selectMenu] });
